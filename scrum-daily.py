        ...
        if jalase_tahvil:
            for t in tasks:
                ...
                if related_to_sadegh(t):
                    ...
                    members["r"].tell("foote, Hoooooh, hahahaha :)))") and members["r"].think(
                        "in bache oomade be man mige! mikhad be man yad bede!! bishin binim baghali")
...
def end_of_phase(self):
    ...
    while not documents:
        everyone.write(documents)
        print("halla chi misheeeeee , age naresim chi misheee")
        PO.think("khob maloome chizi nemishe ina cheghad khengan")
        members.worry = True
    return True
